...
- 現在または1995年時点の自治体を検索して、ナウルと面積・輪郭を比較
- マイ地点（最大2件）
...
本サイトはスケール感を体験するシミュレーターです。現在の市区町村・都道府県の面積には国土地理院の公表値を使用し、海域は含めません。1995年時点の自治体面積は境界データから算出した概算です。シルエットの見た目やメルカトル図法上の表示は、厳密な測量には使用できません。
