...
const missingSites = [
  { id: 660, name: '法隆寺地域の仏教建造物', context: '奈良県生駒郡斑鳩町', geometryFileSources: ['attractions/large-world-heritage-W43549741.geojson', 'attractions/large-world-heritage-W218651765.geojson'], aliases: ['法隆寺', '法起寺', 'Buddhist Monuments in the Horyu-ji Area'], area: 0.153 },
  ...
  { id: 662, name: '屋久島', context: '鹿児島県屋久島町・屋久島国立公園', geometryFileSource: 'attractions/national-park-R5145361.geojson', osmType: 'relation', osmId: 5145361, aliases: ['屋久島国立公園', 'Yakushima'], area: 107.47 },
  ...
  { id: 1193, name: '知床', context: '北海道・知床国立公園', geometryFileSource: 'attractions/national-park-R5664674.geojson', osmType: 'relation', osmId: 5664674, aliases: ['知床国立公園', '知床半島', 'Shiretoko'], area: 711 },
  ...
  { id: 1277, name: '平泉－仏国土（浄土）を表す建築・庭園及び考古学的遺跡群－', context: '岩手県西磐井郡平泉町', geometryFileSource: 'attractions/large-world-heritage-R13044183.geojson', osmType: 'relation', osmId: 13044183, aliases: ['平泉', '中尊寺', '毛越寺', 'Hiraizumi'], area: 1.762 },
  { id: 1449, name: '富岡製糸場と絹産業遺産群', context: '群馬県・代表境界：富岡製糸場', geometryFileSource: 'attractions/large-world-heritage-W313782668.geojson', osmType: 'way', osmId: 313782668, aliases: ['富岡製糸場', '田島弥平旧宅', '高山社跡', '荒船風穴', 'Tomioka Silk Mill and Related Sites'], area: 0.072 },
  { id: 1484, name: '明治日本の産業革命遺産　製鉄・製鋼、造船、石炭産業', context: '九州・山口ほか', query: '端島, 長崎県', aliases: ['明治日本の産業革命遺産', '軍艦島', '端島', "Sites of Japan's Meiji Industrial Revolution"] },
  { id: 1321, name: 'ル・コルビュジエの建築作品－近代建築運動への顕著な貢献－（国立西洋美術館）', context: '東京都台東区上野公園', query: '国立西洋美術館, 台東区', aliases: ['国立西洋美術館', 'ル・コルビュジエの建築作品', 'The Architectural Work of Le Corbusier'] },
  ...
  { id: 1593, name: '百舌鳥・古市古墳群－古代日本の墳墓群－', context: '大阪府堺市・羽曳野市・藤井寺市', query: '大仙陵古墳, 堺市', aliases: ['百舌鳥・古市古墳群', '仁徳天皇陵', '大仙古墳', 'Mozu-Furuichi Kofun Group'] },
  ...
  { id: 1757, name: '飛鳥・藤原の宮都', context: '奈良県明日香村・橿原市・桜井市／代表境界：藤原宮跡', query: '藤原宮跡, 橿原市', aliases: ['飛鳥藤原', '飛鳥宮跡', '藤原宮跡', '石舞台古墳', '高松塚古墳', 'キトラ古墳', 'Ancient Capitals of Asuka and Fujiwara'], area: 1.3799 }
];
...
async function main() {
  ...
  for (const site of missingSites) {
    const result = site.geometryFileSources
      ? {
          geojson: {
            type: 'MultiPolygon',
            coordinates: site.geometryFileSources.flatMap(file => {
              const geometry = JSON.parse(fs.readFileSync(path.join(root, 'data', file), 'utf8')).geometry;
