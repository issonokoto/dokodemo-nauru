...
const MANUAL_OVERRIDES = {
  ...
  // 環境省の「関係市町村名」。広域・海域を含むため代表点だけでは網羅できない。
  'attraction-national-park-W979504733': {
    prefectures: ['三重県', '奈良県', '和歌山県'],
    municipalities: [
      '三重県尾鷲市', '三重県熊野市', '三重県大台町', '三重県大紀町',
      '三重県紀北町', '三重県御浜町', '三重県紀宝町',
      '奈良県五條市', '奈良県吉野町', '奈良県天川村', '奈良県十津川村',
      '奈良県下北山村', '奈良県上北山村', '奈良県川上村',
      '和歌山県田辺市', '和歌山県新宮市', '和歌山県みなべ町',
      '和歌山県那智勝浦町', '和歌山県太地町', '和歌山県北山村',
      '和歌山県串本町', '和歌山県白浜町', '和歌山県すさみ町'
    ]
  },
  'attraction-national-park-W761166517': {
    prefectures: ['青森県', '岩手県', '宮城県'],
    municipalities: [
      '青森県八戸市', '青森県階上町',
      '岩手県宮古市', '岩手県大船渡市', '岩手県久慈市', '岩手県陸前高田市',
      '岩手県釜石市', '岩手県大槌町', '岩手県山田町', '岩手県岩泉町',
      '岩手県田野畑村', '岩手県普代村', '岩手県野田村',
      '宮城県石巻市', '宮城県気仙沼市', '宮城県登米市',
      '宮城県女川町', '宮城県南三陸町'
    ]
  },
